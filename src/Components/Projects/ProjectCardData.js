...
const ProjectCardData = [
    ...
    {
        imgSrc: ProjectImg3,
        projectTitle: 'MERN STACK CRUD APP',
        aboutProject: 'This app is built using MongoDb, Express, React, and Node.This app is using a cloud server Mongodb atlas to perform the create, read, update and delete operations.',
